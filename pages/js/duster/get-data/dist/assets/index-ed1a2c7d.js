...
const _hoisted_1$K = /* @__PURE__ */ createBaseVNode("g", { "clip-path": "url(#clip0_417_21408)" }, [
...
const _hoisted_1$E = /* @__PURE__ */ createBaseVNode("g", { "clip-path": "url(#clip0_390_17708)" }, [
  /* @__PURE__ */ createBaseVNode("path", {
...
function render$w(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  ], 16, _hoisted_1$C)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
    renderSlot(_ctx.$slots, "default"),
    renderSlot(_ctx.$slots, "content", {
      items: $props.items,
      rows: $props.items,
...
const _hoisted_3$k = ["id", "tabindex", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant", "aria-disabled"];
...
function render$s(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm("root")), null, 16, _hoisted_1$y);
}
...
const _hoisted_1$u = ["aria-label", "aria-current", "onClick"];
...
const _hoisted_1$q = /* @__PURE__ */ createBaseVNode("g", { "clip-path": "url(#clip0_414_20836)" }, [
  /* @__PURE__ */ createBaseVNode("path", {
...
const _hoisted_1$p = /* @__PURE__ */ createBaseVNode("g", { "clip-path": "url(#clip0_408_20963)" }, [
  /* @__PURE__ */ createBaseVNode("path", {
    "fill-rule": "evenodd",
    "clip-rule": "evenodd",
...
const _hoisted_1$o = /* @__PURE__ */ createBaseVNode("g", { "clip-path": "url(#clip0_306_11939)" }, [
  /* @__PURE__ */ createBaseVNode("path", {
...
const _hoisted_1$n = /* @__PURE__ */ createBaseVNode("g", { "clip-path": "url(#clip0_417_21589)" }, [
  /* @__PURE__ */ createBaseVNode("path", {
    "fill-rule": "evenodd",
    "clip-rule": "evenodd",
...
const _hoisted_3$c = ["onClick", "onKeydown", "tabindex"];
              ...
              $props.display === "row" ? (openBlock(), createElementBlock("ul", mergeProps({
                ...
                (openBlock(true), createElementBlock(Fragment, null, renderList($options.matchModes, (matchMode, i) => {
                  return openBlock(), createElementBlock("li", mergeProps({
                    ...
                    tabindex: i === 0 ? "0" : null
                  }, $options.getColumnPTOptions("filterRowItem")), toDisplayString(matchMode.label), 17, _hoisted_3$c);
                }), 128)),
...
const _hoisted_1$j = ["tabindex", "colspan", "rowspan", "aria-sort"];
...
`;
  ...
  components: {
    ...
    ArrowDownIcon: script$D,
    ArrowUpIcon: script$C,
    SpinnerIcon: script$H
  }
};
function render$c(_ctx, _cache, $props, $setup, $data, $options) {
...
const _hoisted_1$i = /* @__PURE__ */ createBaseVNode("g", { "clip-path": "url(#clip0_414_20927)" }, [
  /* @__PURE__ */ createBaseVNode("path", {
    "fill-rule": "evenodd",
    "clip-rule": "evenodd",
...
const _hoisted_1$h = /* @__PURE__ */ createBaseVNode("g", { "clip-path": "url(#clip0_414_20939)" }, [
  /* @__PURE__ */ createBaseVNode("path", {
    "fill-rule": "evenodd",
    "clip-rule": "evenodd",
...
const _hoisted_1$e = /* @__PURE__ */ createBaseVNode("g", { "clip-path": "url(#clip0_408_21102)" }, [
  /* @__PURE__ */ createBaseVNode("path", {
    "fill-rule": "evenodd",
    "clip-rule": "evenodd",
...
const _hoisted_1$d = /* @__PURE__ */ createBaseVNode("g", { "clip-path": "url(#clip0_334_13179)" }, [
  /* @__PURE__ */ createBaseVNode("path", {
    "fill-rule": "evenodd",
    "clip-rule": "evenodd",
    ...
    createBaseVNode("div", mergeProps({ class: "p-panel-header" }, _ctx.ptm("header")), [
      renderSlot(_ctx.$slots, "header", {
        ...
        $props.header ? (openBlock(), createElementBlock("span", mergeProps({
          ...
          id: $options.ariaId + "_header",
          class: "p-panel-title"
        }, _ctx.ptm("title")), toDisplayString($props.header), 17, _hoisted_1$a)) : createCommentVNode("", true)
      ]),
...
const _hoisted_1$8 = ["fill", "stroke-width"];
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    (openBlock(), createElementBlock("svg", mergeProps({
      ...
      createBaseVNode("circle", mergeProps({
        ...
        strokeMiterlimit: "10"
      }, _ctx.ptm("circle")), null, 16, _hoisted_1$8)
    ], 16))
  ], 16);
}
...
axios.default = axios;
const axios$1 = axios;
const _hoisted_1$6 = /* @__PURE__ */ createBaseVNode("div", { class: "flex" }, [
...
const _hoisted_2$3 = { class: "text-xl text-900 font-bold" };
        ...
        createVNode(_component_DataTable, {
          ...
          header: withCtx(() => [
            createBaseVNode("div", _hoisted_1$5, [
              createBaseVNode("span", _hoisted_2$3, toDisplayString(__props.title), 1)
            ]),
            createVNode(_component_Message, { severity: __props.alertType }, {
              default: withCtx(() => [
                createTextVNode(toDisplayString(__props.alertContent), 1)
              ]),
              _: 1
            }, 8, ["severity"])
          ]),
...
const _hoisted_1$4 = { class: "grid mt-3" };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$4, [
        createBaseVNode("div", _hoisted_2$2, [
          ...
          updateMessage.value ? (openBlock(), createElementBlock("span", _hoisted_3$3, [
            _hoisted_4$2,
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        createBaseVNode("div", _hoisted_2$1, [
          ...
          message.value ? (openBlock(), createElementBlock("span", _hoisted_3$2, [
            _hoisted_4$1,
...
const _hoisted_1$2 = /* @__PURE__ */ createBaseVNode("p", { class: "m-4" }, [
...
const _sfc_main$1 = {};
const _hoisted_1$1 = /* @__PURE__ */ createStaticVNode('<div class="grid" data-v-873ad89e><div class="col" data-v-873ad89e><a class="brand-logo" href="https://med.stanford.edu/" data-v-873ad89e>Stanford Medicine</a><div style="display:inline;float:left;" class="mt-2" data-v-873ad89e><div class="font-bold text-left" style="font-size:1.25em;" data-v-873ad89e>DUSTER</div><div class="text-sm font-italic" data-v-873ad89e>Research Technology, TDS</div></div></div><div class="col mt-1" data-v-873ad89e><p class="text-xl font-italic" data-v-873ad89e>Data Upload Service for Translational rEsearch on Redcap</p></div></div><div class="grid text-white text-lg" style="background-color:#53565A;" data-v-873ad89e><div class="col-offset-9 col-2" data-v-873ad89e><a href="https://med.stanford.edu/duster" class="text-white" target="_blank" data-v-873ad89e>Duster Website</a></div></div>', 2);
const _hoisted_3$1 = [
  _hoisted_1$1
];
function _sfc_render(_ctx, _cache) {
  return openBlock(), createElementBlock("nav", null, _hoisted_3$1);
}
const DusterHeader = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__scopeId", "data-v-873ad89e"]]);
...
const _hoisted_19 = /* @__PURE__ */ createBaseVNode("b", null, "Cohort:", -1);
...
const _hoisted_25 = /* @__PURE__ */ createBaseVNode("p", null, " Enter an email address to get notifications when data request is complete. ", -1);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
      ...
      if (prodStatus) {
        ...
        if (!hasError(response)) {
          ...
          if ((response == null ? void 0 : response.data.dataRequestStatus) === "sync") {
            ...
            errorMessage.value = "User " + (response == null ? void 0 : response.data.redcapUserName) + " Data Request Already in progress.";
            ...
            step.value = 4;
            saveMessage.value = "User " + (response == null ? void 0 : response.data.redcapUserName) + " Data Request Already in progress. This view will update status every " + asyncPollInterval.value + " seconds.";
            asyncPollStatus();
          } else {
            if ((response == null ? void 0 : response.data.dataRequestStatus) && (response == null ? void 0 : response.data.dataRequestStatus) !== "no status") {
              previousRequestStatus.value = "Previous request status: " + (response == null ? void 0 : response.data.dataRequestStatus) + " at " + (response == null ? void 0 : response.data.dataRequestTimestamp);
            }
    ...
    const asyncRequestData = () => {
      ...
      saveMessage.value = "Data request submitted.  An email will be sent to " + email.value + " when it is completed.  This view will update status every " + asyncPollInterval.value + " seconds.";
      asyncPollStatus();
    };
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1, [
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("div", _hoisted_3, [
              createVNode(DusterHeader),
              createVNode(_component_Panel, { header: "DUSTER: Get Data" }, {
                default: withCtx(() => [
                  errorMessage.value ? (openBlock(), createElementBlock("div", _hoisted_4, [
                    createVNode(_component_Message, { severity: "error" }, {
                      default: withCtx(() => [
                        createBaseVNode("span", { innerHTML: errorMessage.value }, null, 8, _hoisted_5)
                      ]),
                      _: 1
                    }),
                  ...
                  createBaseVNode("div", null, [
                    isLoading.value && !isLoaded.value ? (openBlock(), createElementBlock("p", _hoisted_6, [
                      createTextVNode(" Loading "),
                      _hoisted_7
                    ])) : createCommentVNode("", true),
                    isLoaded.value ? (openBlock(), createElementBlock("div", _hoisted_8, [
                      step.value == 1 && dusterData.value.missing_fields ? (openBlock(), createElementBlock("div", _hoisted_9, [
                      ...
                      step.value == 2 ? (openBlock(), createElementBlock("div", _hoisted_10, [
                        createVNode(_component_Card, null, {
                          content: withCtx(() => [
                            !dusterData.value.missing_data && !dusterData.value.rp_data ? (openBlock(), createElementBlock("div", _hoisted_11, [
                              createVNode(_component_Message, { severity: "danger" }, {
                                default: withCtx(() => [
                                  createTextVNode(" Your REDCap project contains no records. Add at least one record to your project in order to proceed. ")
                                ]),
                                _: 1
                              })
                            ])) : dusterData.value.missing_data ? (openBlock(), createElementBlock("div", _hoisted_12, [
                          ...
                          footer: withCtx(() => [
                            ...
                            createVNode(_component_Button, {
                              text: "",
                              outlined: "",
                              onClick: _cache[3] || (_cache[3] = ($event) => goToUrl(record_base_url.value)),
                              class: "p-button-secondary",
                              size: "small",
                              icon: "pi pi-times",
                              label: "Cancel"
                      ...
                      step.value == 3 ? (openBlock(), createElementBlock("div", _hoisted_13, [
                        ...
                        dusterData.value.rp_data ? (openBlock(), createBlock(_component_Card, { key: 1 }, {
                          content: withCtx(() => [
                            createVNode(_sfc_main$5, {
                              title: "Data Records",
                              "alert-type": "info",
                          ...
                          footer: withCtx(() => [
                            createVNode(_component_Button, {
                              ...
                              onClick: _cache[4] || (_cache[4] = ($event) => syncCohort())
                            }),
                            createVNode(_component_Button, {
                              ...
                              onClick: _cache[5] || (_cache[5] = ($event) => showAsyncNotify.value = true)
                            }),
                            createVNode(_component_Button, {
                              class: "p-button-secondary",
                              size: "small",
                              icon: "pi pi-times",
                              label: "Cancel",
                              onClick: _cache[6] || (_cache[6] = ($event) => goToUrl(project_setup_url.value))
                            })
                          ]),
                          _: 1
                        })) : createCommentVNode("", true)
                      ])) : createCommentVNode("", true),
                      step.value == 4 ? (openBlock(), createElementBlock("div", _hoisted_14, [
                        createBaseVNode("p", null, [
                          createBaseVNode("strong", null, [
                            createBaseVNode("span", { innerHTML: saveMessage.value }, null, 8, _hoisted_15)
                          ])
                        ]),
                        !isAsyncRequest.value && dusterData.value.rp_data ? (openBlock(), createElementBlock("div", _hoisted_16, [
                          createBaseVNode("div", _hoisted_17, [
                            createBaseVNode("div", _hoisted_18, [
                              _hoisted_19,
                              cohortMessage.value ? (openBlock(), createElementBlock("span", _hoisted_20, [
                                _hoisted_21,
                        ...
                        ])) : isAsyncRequest.value && dataRequestLog.value != null ? (openBlock(), createElementBlock("div", _hoisted_23, [
                        ...
                        createVNode(_component_Dialog, {
                          ...
                          "onUpdate:visible": _cache[9] || (_cache[9] = ($event) => confirmCancel.value = $event),
                          "max-width": "500px",
                          modal: "",
                          header: "Cancel"
                        }, {
                            ...
                            createVNode(_component_Card, null, {
                              content: withCtx(() => [
                                createVNode(_component_Message, {
                                  ...
                                  default: withCtx(() => [
                                    createTextVNode(" Are you sure you want to cancel data retrieval? "),
                                    _hoisted_24,
                              ...
                              footer: withCtx(() => [
                                createVNode(_component_Button, {
                                  ...
                                  icon: "pi pi-check",
                                  label: "No, Continue",
                                  onClick: _cache[7] || (_cache[7] = ($event) => confirmCancel.value = false)
                                }),
                                createVNode(_component_Button, {
                                  ...
                                  label: "Yes, Cancel",
                                  outlined: "",
                                  onClick: _cache[8] || (_cache[8] = ($event) => cancel())
                                })
                              ]),
                              _: 1
                            })
                        ...
                        isAsyncRequest.value ? (openBlock(), createBlock(_component_Button, {
                          ...
                          size: "small",
                          icon: "pi pi-home",
                          onClick: _cache[10] || (_cache[10] = ($event) => goToUrl(project_setup_url.value))
                        })) : createCommentVNode("", true),
                        totalProgress.value < 100 ? (openBlock(), createBlock(_component_Button, {
                          ...
                          icon: "pi pi-times",
                          label: "Cancel",
                          onClick: _cache[11] || (_cache[11] = ($event) => confirmCancel.value = true)
                          ...
                          size: "small",
                          icon: "pi pi-download",
                          onClick: _cache[12] || (_cache[12] = ($event) => goToUrl(data_exports_url.value))
                        }))
                      ])) : createCommentVNode("", true),
                      createVNode(_component_Dialog, {
        ...
        systemError.value ? (openBlock(), createBlock(_sfc_main$2, { key: 0 })) : createCommentVNode("", true)
      ], 64);
    };
  }
});
...
const primevue_min = "";
const primeicons = "";
createApp(_sfc_main).use(PrimeVue).component("Button", script$G).component("Card", script$F).component("Column", script$E).component("DataTable", script$c).component("Dialog", script$9).component("InputText", script$s).component("Message", script$5).component("Panel", script$3).component("ProgressBar", script$2).component("ProgressSpinner", script$1).component("Toolbar", script).mount("#app");
