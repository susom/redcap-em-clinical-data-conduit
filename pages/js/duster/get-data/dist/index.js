    ...
    watch(localCohortProgress, async (updatedCohort) => {
      ...
      if (updatedCohort === 100) {
        for (var i = 0; i < numQueries.value; i++) {
          ...
          const dataSync = await axios$1.get(props.dataApiUrl + "&action=realTimeDataRequest&query=" + JSON.stringify(props.queries[i]));
          numComplete.value++;
...
const _hoisted_24 = /* @__PURE__ */ createBaseVNode("ul", null, null, -1);
const _hoisted_25 = {
  key: 2,
  class: "text-left"
};
...
const _hoisted_28 = /* @__PURE__ */ createBaseVNode("b", null, "Researcher Provided Information:", -1);
const _hoisted_29 = { key: 0 };
const _hoisted_30 = /* @__PURE__ */ createBaseVNode("br", null, null, -1);
const _hoisted_31 = { class: "col-8" };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    setInterval(() => {
      axios$1.get(projectConfig.refresh_session_url).then((response) => {
    ...
    const asyncNotifyMessage = ref("Enter an email address to get notifications when data request is complete.");
    const countDownUpdate = ref("");
    ...
    const syncCohort = async () => {
      ...
      try {
        const cohortSync = await axios$1.get(get_data_url.value + "&action=realTimeSyncCohort");
    ...
    const updateProgress = (dataSync) => {
      ...
      if (!hasError(dataSync)) {
        ...
        if (totalProgress.value === 100) {
          ...
          saveMessage.value = "";
          axios$1.get(get_data_url.value + "&action=logStatus&status=fail");
        }
      }
    };
    const asyncRequestData = async () => {
      ...
      if (!emailParam) {
        ...
        saveMessage.value = "<p>Background Data request submitted.  An email will be sent to " + email.value + " when it is completed.</p><p>This view will request status every " + asyncPollInterval.value + " seconds.</p>";
        await sleep(1e4);
        asyncPollStatus();
      }
    };
    const sleepWithCountDown = async (milliseconds) => {
    ...
    const asyncPollStatus = async () => {
      ...
      while (!complete) {
        ...
        let response = await axios$1.get(get_data_url.value + "&action=asyncDataLog").catch(function(error) {
          complete = true;
          errorMessage.value += error.message + "<br>";
          systemError.value = true;
        });
        if (!hasError(response) && (response == null ? void 0 : response.data) && response.data.data_request_log) {
          const today = /* @__PURE__ */ new Date();
          updateTime.value = zeropad(today.getHours()) + ":" + zeropad(today.getMinutes()) + ":" + zeropad(today.getSeconds());
          ...
          if (cancelled.value) {
            ...
            for (const formName in dataRequestLog.value) {
              complete = complete && (dataRequestLog.value[formName].complete || dataRequestLog.value[formName].fail);
        ...
        if (!complete && count > asyncPollLimit.value) {
          ...
          complete = true;
          errorMessage.value = "The max number of status updates has been reached.  Click 'Duster: Get Data' link to continue to monitor this background request.";
        }
        if (!complete) {
          console.log("not complete. sleep " + asyncPollInterval.value + " seconds");
          await sleepWithCountDown(asyncPollInterval.value * 1e3);
          ...
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("div", _hoisted_3, [
              ...
              createBaseVNode("div", null, [
                isLoading.value && !isLoaded.value && !errorMessage.value ? (openBlock(), createElementBlock("p", _hoisted_9, [
                  _hoisted_10,
                ...
                isLoaded.value ? (openBlock(), createElementBlock("div", _hoisted_11, [
                  ...
                  step.value == 4 ? (openBlock(), createElementBlock("div", _hoisted_20, [
                    !isAsyncRequest.value && totalProgress.value < 100 ? (openBlock(), createBlock(_component_Message, {
                      key: 0,
                      closeable: false,
                      severity: "warn"
                    }, {
                    ...
                    createBaseVNode("p", null, [
                      createBaseVNode("strong", null, [
                        ...
                        createTextVNode(),
                        createBaseVNode("span", { innerHTML: nextStatusUpdateMessage.value }, null, 8, _hoisted_22)
                      ])
                    ]),
                    failures.value.length > 0 ? (openBlock(), createElementBlock("div", _hoisted_23, [
                      createTextVNode(" Query Failures "),
                      _hoisted_24,
                      (openBlock(true), createElementBlock(Fragment, null, renderList(failures.value, (value, key) => {
                        return openBlock(), createElementBlock("li", { key }, toDisplayString(value), 1);
                      }), 128))
                    ])) : createCommentVNode("", true),
                    !isAsyncRequest.value && dusterData.value.rp_data ? (openBlock(), createElementBlock("div", _hoisted_25, [
                      createBaseVNode("div", _hoisted_26, [
                        createBaseVNode("div", _hoisted_27, [
                          _hoisted_28,
                          cohortMessage.value ? (openBlock(), createElementBlock("span", _hoisted_29, [
                            _hoisted_30,
                    ...
                    ])) : isAsyncRequest.value && dataRequestLog.value != null ? (openBlock(), createElementBlock("div", _hoisted_32, [
                    ...
                    totalProgress.value < 100 && !cancelled.value ? (openBlock(), createBlock(_component_Button, {
                      key: 4,
                      class: "p-button-secondary",
                      size: "small",
                      icon: "pi pi-times",
                  ...
                  createVNode(_component_Dialog, {
                    ...
                    default: withCtx(() => [
                      createVNode(_component_Card, { style: { "box-shadow": "none" } }, {
                        content: withCtx(() => [
                          createBaseVNode("p", null, toDisplayString(asyncNotifyMessage.value), 1),
