...
// Close cURL resource
curl_close($ch);
// TODO no error handling on saving config

/* Set up REDCap to STARR Link EM and queries */
$module->emLog("Setting up REDCap to STARR Link for REDCap project pid $project_id");
